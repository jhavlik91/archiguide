/**
 * Generování veřejného slugu firmy (T010). Čistá vrstva (bez DB) — uniqueness
 * proti databázi řeší service. Slug vzniká z názvu firmy při jejím založení a
 * dál se nemění, aby veřejný odkaz `/firma/[slug]` zůstal stabilní.
 */

/** Maximální délka slug rootu (bez případného sufixu pro unikátnost). */
export const SLUG_MAX_LENGTH = 60;

/** Fallback, když z názvu nezbude žádný použitelný znak (např. jen emoji). */
export const SLUG_FALLBACK = "firma";
