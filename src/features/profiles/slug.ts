/**
 * Generování veřejného slugu profilu (T008). Čistá vrstva (bez DB) — uniqueness
 * proti databázi řeší service. Slug vzniká z titulku profilu při první publikaci
 * a dál se nemění, aby veřejný odkaz `/profesional/[slug]` zůstal stabilní.
 */
...
export const SLUG_FALLBACK = "profil";
