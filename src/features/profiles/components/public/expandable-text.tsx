...
/**
 * Dlouhé bio zobrazí sbalené s možností rozbalit (T008 edge case: velmi dlouhé
 * bio). Krátký text se vykreslí celý bez ovládání. `whitespace-pre-line` zachová
 * odstavce z textarey. Klientská komponenta — jediná interaktivní část stránky.
 */
