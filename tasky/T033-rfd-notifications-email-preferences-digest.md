...
## Acceptance criteria
- [ ] Nová reakce na poptávku → e-mail dle policy (Y) s odkazem do kontextu; nová zpráva bez opt-in e-mail negeneruje.
- [ ] Změna preference se okamžitě projeví (unit test dispatch rozhodování).
- [ ] Unsubscribe z patičky funguje bez přihlášení a jen pro danou kategorii.
- [ ] Digest neobsahuje obsah zpráv ani adresy; prázdný digest se neodešle.
- [ ] Selhání e-mail providera neshodí vytvoření in-app notifikace.
