-- CreateEnum
CREATE TYPE "MessageModerationState" AS ENUM ('visible', 'hidden');
...
CREATE TABLE "messages" (
    ...
    "moderationState" "MessageModerationState" NOT NULL DEFAULT 'visible',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "conversations_dedupeKey_key" ON "conversations"("dedupeKey");
